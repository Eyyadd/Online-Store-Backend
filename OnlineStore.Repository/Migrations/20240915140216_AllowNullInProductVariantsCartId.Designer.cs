...
namespace OnlineStore.Repository.Migrations
{
    ...
    [Migration("20240915140216_AllowNullInProductVariantsCartId")]
    partial class AllowNullInProductVariantsCartId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineStore.Domain.Entities.ProductVariants", b =>
                {
                    ...
                    b.Property<decimal>("PrecentageOfSales")
                        ...
                        .HasColumnType("decimal(18,2)")
                        .HasComputedColumnSql("(([TotalQuantity]-[Quantity])/[TotalQuantity])*100");
