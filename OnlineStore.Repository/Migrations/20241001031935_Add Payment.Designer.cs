...
namespace OnlineStore.Repository.Migrations
{
    ...
    [Migration("20241001031935_Add Payment")]
            ...
            modelBuilder.Entity("OnlineStore.Domain.Entities.BestSeller", b =>
                {
                    ...
                    b.Property<decimal>("PrecentageOfSales")
            ...
            modelBuilder.Entity("OnlineStore.Domain.Entities.ProductVariants", b =>
                {
                    ...
                    b.Property<decimal>("PrecentageOfSales")
                        ...
                        .HasColumnType("decimal(18,2)")
                        .HasComputedColumnSql("((CAST([TotalQuantity] - [Quantity] AS DECIMAL) / [TotalQuantity]) * 100)");
            ...
            modelBuilder.Entity("OnlineStore.Domain.Entities.ProductVariants", b =>
                {
                    ...
                    b.HasOne("OnlineStore.Domain.Entities.ProductVariant", "Product")
